...
class _$SetupParametersImpl implements _SetupParameters {
  const _$SetupParametersImpl(
      ...
      @JsonKey(name: 'defaultShippingDetails') this.shippingDetails,
